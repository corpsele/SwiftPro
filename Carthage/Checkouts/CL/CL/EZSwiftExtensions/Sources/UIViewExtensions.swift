...
extension UIView {
    ...
    @objc public convenience init(superView: UIView, padding: CGFloat) {
    ...
    @objc public convenience init(superView: UIView) {
...
extension UIView {
    ...
    @objc public func resizeToFitSubviews() {
        var width: CGFloat = 0
    ...
    /// EZSE: resizes this view so it fits the largest subview
    @objc public func resizeToFitSubviews(_ tagsToIgnore: [Int]) {
        var width: CGFloat = 0
        var height: CGFloat = 0
        for someView in self.subviews {
            let aView = someView
    ...
    @objc public func resizeToFitWidth() {
    ...
    @objc public func resizeToFitHeight() {
    ...
    @objc public func leftOffset(_ offset: CGFloat) -> CGFloat {
        return self.left - offset
    }

    /// EZSE: getter for an rightwards offset position from the rightmost edge.
    @objc public func rightOffset(_ offset: CGFloat) -> CGFloat {
        return self.right + offset
    }

    /// EZSE: aligns the view to the top by a given offset.
    @objc public func topOffset(_ offset: CGFloat) -> CGFloat {
        return self.top - offset
    }

    /// EZSE: align the view to the bottom by a given offset.
    @objc public func bottomOffset(_ offset: CGFloat) -> CGFloat {
        return self.bottom + offset
    }

    //TODO: Add to readme
    /// EZSE: align the view widthwise to the right by a given offset.
    @objc public func alignRight(_ offset: CGFloat) -> CGFloat {
        return self.w - offset
    }

    /// EZSwiftExtensions
    @objc public func reorderSubViews(_ reorder: Bool = false, tagsToIgnore: [Int] = []) -> CGFloat {
    ...
    @objc public func centerXInSuperView() {
    ...
    @objc public func centerYInSuperView() {
        guard let parentView = superview else {
            assertionFailure("EZSwiftExtensions Error: The view \(self) doesn't have a superview")
            return
        }
    ...
    @objc public func centerInSuperView() {
...
extension UIView {
    /// EZSwiftExtensions
    @objc public func setRotationX(_ x: CGFloat) {
    ...
    /// EZSwiftExtensions
    @objc public func setRotationY(_ y: CGFloat) {
        var transform = CATransform3DIdentity
        transform.m34 = 1.0 / -1000.0
    ...
    /// EZSwiftExtensions
    @objc public func setRotationZ(_ z: CGFloat) {
        var transform = CATransform3DIdentity
        transform.m34 = 1.0 / -1000.0
    ...
    /// EZSwiftExtensions
    @objc public func setRotation(x: CGFloat, y: CGFloat, z: CGFloat) {
        var transform = CATransform3DIdentity
        transform.m34 = 1.0 / -1000.0
        transform = CATransform3DRotate(transform, x.degreesToRadians(), 1.0, 0.0, 0.0)
        transform = CATransform3DRotate(transform, y.degreesToRadians(), 0.0, 1.0, 0.0)
    ...
    /// EZSwiftExtensions
    @objc public func setScale(x: CGFloat, y: CGFloat) {
        var transform = CATransform3DIdentity
        transform.m34 = 1.0 / -1000.0
...
extension UIView {
    /// EZSwiftExtensions
    @objc public func setCornerRadius(radius: CGFloat) {
    ...
    /// EZSwiftExtensions
    @objc public func addBorder(width: CGFloat, color: UIColor) {
    ...
    /// EZSwiftExtensions
    @objc public func addBorderTop(size: CGFloat, color: UIColor) {
        addBorderUtility(x: 0, y: 0, width: frame.width, height: size, color: color)
    }

    //TODO: add to readme
    /// EZSwiftExtensions
    @objc public func addBorderTopWithPadding(size: CGFloat, color: UIColor, padding: CGFloat) {
        addBorderUtility(x: padding, y: 0, width: frame.width - padding*2, height: size, color: color)
    }

    /// EZSwiftExtensions
    @objc public func addBorderBottom(size: CGFloat, color: UIColor) {
        addBorderUtility(x: 0, y: frame.height - size, width: frame.width, height: size, color: color)
    }

    /// EZSwiftExtensions
    @objc public func addBorderLeft(size: CGFloat, color: UIColor) {
        addBorderUtility(x: 0, y: 0, width: size, height: frame.height, color: color)
    }

    /// EZSwiftExtensions
    @objc public func addBorderRight(size: CGFloat, color: UIColor) {
    ...
    //TODO: add this to readme
    /// EZSwiftExtensions
    @objc public func drawCircle(fillColor: UIColor, strokeColor: UIColor, strokeWidth: CGFloat) {
    ...
    //TODO: add this to readme
    /// EZSwiftExtensions
    @objc public func drawStroke(width: CGFloat, color: UIColor) {
        let path = UIBezierPath(roundedRect: CGRect(x: 0, y: 0, width: self.w, height: self.w), cornerRadius: self.w/2)
        let shapeLayer = CAShapeLayer ()
        shapeLayer.path = path.cgPath
...
extension UIView {
    /// EZSwiftExtensions
    @objc public func spring(animations: @escaping (() -> Void), completion: ((Bool) -> Void)? = nil) {
        spring(duration: UIViewAnimationDuration, animations: animations, completion: completion)
    }

    /// EZSwiftExtensions
    @objc public func spring(duration: TimeInterval, animations: @escaping (() -> Void), completion: ((Bool) -> Void)? = nil) {
        UIView.animate(
    ...
    /// EZSwiftExtensions
    @objc public func animate(duration: TimeInterval, animations: @escaping (() -> Void), completion: ((Bool) -> Void)? = nil) {
        UIView.animate(withDuration: duration, animations: animations, completion: completion)
    }

    /// EZSwiftExtensions
    @objc public func animate(animations: @escaping (() -> Void), completion: ((Bool) -> Void)? = nil) {
...
extension UIView {
    ...
    @objc public func addTapGesture(tapNumber: Int = 1, action: ((UITapGestureRecognizer) -> Void)?) {
    ...
    /// EZSwiftExtensions
    @objc public func addSwipeGesture(direction: UISwipeGestureRecognizerDirection, numberOfTouches: Int = 1, target: AnyObject, action: Selector) {
    ...
    /// EZSwiftExtensions - Make sure you use  "[weak self] (gesture) in" if you are using the keyword self inside the closure or there might be a memory leak
    @objc public func addSwipeGesture(direction: UISwipeGestureRecognizerDirection, numberOfTouches: Int = 1, action: ((UISwipeGestureRecognizer) -> Void)?) {
    ...
    /// EZSwiftExtensions - Make sure you use  "[weak self] (gesture) in" if you are using the keyword self inside the closure or there might be a memory leak
    @objc public func addPanGesture(action: ((UIPanGestureRecognizer) -> Void)?) {
    ...
    /// EZSwiftExtensions - Make sure you use  "[weak self] (gesture) in" if you are using the keyword self inside the closure or there might be a memory leak
    @objc public func addPinchGesture(action: ((UIPinchGestureRecognizer) -> Void)?) {
    ...
    /// EZSwiftExtensions - Make sure you use  "[weak self] (gesture) in" if you are using the keyword self inside the closure or there might be a memory leak
    @objc public func addLongPressGesture(action: ((UILongPressGestureRecognizer) -> Void)?) {
...
extension UIView {
    ...
    @objc public func shakeViewForTimes(_ times: Int) {
