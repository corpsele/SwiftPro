...
@interface UICollectionView (DYCollectionViewBinder)
...
/**
 隐形代理
 */
@property (nonatomic, strong) DYCollectionViewAgent *agent;
...
- (UICollectionView *)setNumberOfItemsInSection:(NSIntegerCollectionViewIndexPath)block;

- (UICollectionView*)setCanMoveItemAtIndexPath:(BOOLCollectionViewIndexPath)block;

- (UICollectionView*)setTargetCollectionIndexPathForMoveFromRowAtIndexPath:(NSIndexPathUICollectionViewNSIndexPathNSIndexPath)block;
