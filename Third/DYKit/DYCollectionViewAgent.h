...
@interface DYCollectionViewAgent : NSObject <UICollectionViewDataSource,UICollectionViewDelegate, UICollectionViewDragDelegate, UICollectionViewDropDelegate>
...
typedef BOOL (^BOOLCollectionViewIndexPath)(UICollectionView *collectionView, NSIndexPath *fromIndexPath);
typedef BOOL (^BOOLCanHandleDropSession)(UICollectionView *collectionView, id<UIDropSession> session);
typedef NSArray<UIDragItem *> * (^UIDragItemItemsForBeginningDragSession)(UICollectionView *collectionView, id<UIDragSession> session, NSIndexPath *indexPath);
...
typedef NSInteger (^NSIntegerCollectionViewIndexPath)(UICollectionView *collectionView, NSInteger section);
@property (nonatomic, copy) NSIntegerTableViewIndexPath numberOfRowsInSection;
@property (nonatomic, copy) NSIntegerCollectionViewIndexPath numberOfItemsInSection;
...
@property (nonatomic, copy) BOOLCollectionViewIndexPath canMoveItemAtIndexPath;
@property (nonatomic, copy) BOOLCanHandleDropSession canHandleDropSession;
@property (nonatomic, copy) UIDragItemItemsForBeginningDragSession itemsForBeginningDragSession;
...
typedef NSIndexPath *(^NSIndexPathUICollectionViewNSIndexPathNSIndexPath)(UICollectionView *collectionView,NSIndexPath *sourceIndexPath, NSIndexPath *proposedDestinationIndexPath);
typedef void(^MoveItemAtNSIndexPath)(UICollectionView *collectionView, NSIndexPath *sourceIndexPath, NSIndexPath *destinationIndexPath);
@property (nonatomic, copy) NSIndexPathUITableViewNSIndexPathNSIndexPath targetIndexPathForMoveFromRowAtIndexPath;
@property (nonatomic, copy) NSIndexPathUICollectionViewNSIndexPathNSIndexPath targetCollectionIndexPathForMoveFromRowAtIndexPath;
@property (nonatomic, copy)MoveItemAtNSIndexPath collectionMoveItemAtNSIndexPath;
