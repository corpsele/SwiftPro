...
#define isiPhoneX (kStatusBarHeight > 20.0 ? YES : NO)
...
@interface KxMovieViewController () {
    ...
    UIBarButtonItem     *_btnFullScreen;
...
//    if (isIphoneX) {
//        CGRect rect = bounds;
//        rect.origin.y = kTopHeight;
//        rect.size.height = rect.size.height - 34.0;
//        bounds = rect;
//    }
...
_messageLabel.hidden = YES;
    ...
    CGFloat y = 0;
    CGFloat heightY = height-botH;
    CGFloat heightheight = botH;
    ...
    _topHUD    = [[UIView alloc] initWithFrame:CGRectMake(0,y,0,0)];
    _topBar    = [[UIToolbar alloc] initWithFrame:CGRectMake(0, y, width, topH)];
    _bottomBar = [[UIToolbar alloc] initWithFrame:CGRectMake(0, heightY, width, heightheight)];
...
- (void)resizeView{
    ...
    _topBar.frame = CGRectMake(0, y, width, topH);
    _bottomBar.frame = CGRectMake(0, heightY, width, heightheight);
