...
- (_Bool)uninstallApplication:(id)arg1 withOptions:(id)arg2 error:(id *)arg3 usingBlock:(id)arg4;
...
- (void)enumerateApplicationsOfType:(unsigned long long)arg1 legacySPI:(_Bool)arg2 block:(id)arg3;
- (void)enumerateBundlesOfType:(unsigned long long)arg1 block:(id)arg2;
- (void)enumerateBundlesOfType:(unsigned long long)arg1 legacySPI:(_Bool)arg2 block:(id)arg3;
...
- (id)installedPlugins;
- (void)openApplicationWithBundleIdentifier:(id)arg1 configuration:(id)arg2 completionHandler:(id)arg3;
- (void)openURL:(id)arg1 configuration:(id)arg2 completionHandler:(id)arg3;
...
//- (id)operationToOpenResource:(id)arg1 usingApplication:(id)arg2 uniqueDocumentIdentifier:(id)arg3 isContentManaged:(_Bool)arg4 sourceAuditToken:(const  *)arg5 userInfo:(id)arg6 options:(id)arg7 delegate:(id)arg8;
